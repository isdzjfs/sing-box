...
const file_daemon_started_service_proto_rawDesc = "" +
	...
	"\x1bUSB_BACKEND_WINDOWS_VBOXUSB\x10\x042\xce\x1a\n" +
...
var file_daemon_started_service_proto_msgTypes = make([]protoimpl.MessageInfo, 105)
var file_daemon_started_service_proto_goTypes = []any{
	...
	(*Log_Message)(nil),                       // 108: daemon.Log.Message
	nil,                                       // 109: daemon.OpenConnectAuthFormResponse.ValuesEntry
	(*emptypb.Empty)(nil),                     // 110: google.protobuf.Empty
}
var file_daemon_started_service_proto_depIdxs = []int32{
	4,   // 0: daemon.ServiceStatus.status:type_name -> daemon.ServiceStatus.Type
	108, // 1: daemon.Log.messages:type_name -> daemon.Log.Message
	...
	109, // 55: daemon.OpenConnectAuthFormResponse.values:type_name -> daemon.OpenConnectAuthFormResponse.ValuesEntry
	...
	110, // 66: daemon.StartedService.GetVersion:input_type -> google.protobuf.Empty
	110, // 67: daemon.StartedService.SubscribeServiceStatus:input_type -> google.protobuf.Empty
	110, // 68: daemon.StartedService.SubscribeLog:input_type -> google.protobuf.Empty
	110, // 69: daemon.StartedService.GetDefaultLogLevel:input_type -> google.protobuf.Empty
	110, // 70: daemon.StartedService.ClearLogs:input_type -> google.protobuf.Empty
	7,   // 71: daemon.StartedService.SubscribeStatus:input_type -> daemon.SubscribeStatusRequest
	110, // 72: daemon.StartedService.SubscribeGroups:input_type -> google.protobuf.Empty
	110, // 73: daemon.StartedService.GetClashModeStatus:input_type -> google.protobuf.Empty
	110, // 74: daemon.StartedService.SubscribeClashMode:input_type -> google.protobuf.Empty
	...
	110, // 82: daemon.StartedService.CloseAllConnections:input_type -> google.protobuf.Empty
	110, // 83: daemon.StartedService.GetDeprecatedWarnings:input_type -> google.protobuf.Empty
	110, // 84: daemon.StartedService.GetStartedAt:input_type -> google.protobuf.Empty
	110, // 85: daemon.StartedService.SubscribeOutbounds:input_type -> google.protobuf.Empty
	...
	110, // 88: daemon.StartedService.SubscribeTailscaleStatus:input_type -> google.protobuf.Empty
	...
	44,  // 92: daemon.StartedService.StartTailscaleSSHSession:input_type -> daemon.TailscaleSSHClientMessage
	54,  // 93: daemon.StartedService.SubscribeTaildropInbox:input_type -> daemon.SubscribeTaildropInboxRequest
	55,  // 94: daemon.StartedService.MarkTaildropInboxRead:input_type -> daemon.MarkTaildropInboxReadRequest
	59,  // 95: daemon.StartedService.SendTaildropFiles:input_type -> daemon.TaildropSendClientMessage
	66,  // 96: daemon.StartedService.DownloadTaildropFile:input_type -> daemon.DownloadTaildropFileRequest
	68,  // 97: daemon.StartedService.DeleteTaildropFile:input_type -> daemon.DeleteTaildropFileRequest
	69,  // 98: daemon.StartedService.CancelTaildropReceiving:input_type -> daemon.CancelTaildropReceivingRequest
	70,  // 99: daemon.StartedService.ProvideUSBDevices:input_type -> daemon.USBProviderMessage
	110, // 100: daemon.StartedService.SubscribeUSBIPServerStatus:input_type -> google.protobuf.Empty
	110, // 101: daemon.StartedService.SubscribeOpenConnectStatus:input_type -> google.protobuf.Empty
	97,  // 102: daemon.StartedService.SubmitOpenConnectAuthResponse:input_type -> daemon.OpenConnectAuthResponseSubmission
	98,  // 103: daemon.StartedService.CancelOpenConnectAuthChallenge:input_type -> daemon.OpenConnectAuthChallengeCancel
	110, // 104: daemon.StartedService.SubscribeOpenVPNStatus:input_type -> google.protobuf.Empty
	103, // 105: daemon.StartedService.SubmitOpenVPNChallengeResponse:input_type -> daemon.OpenVPNChallengeSubmission
	104, // 106: daemon.StartedService.CancelOpenVPNChallenge:input_type -> daemon.OpenVPNChallengeCancel
	110, // 107: daemon.StartedService.SubscribeNotifications:input_type -> google.protobuf.Empty
	...
	110, // 112: daemon.StartedService.ClearLogs:output_type -> google.protobuf.Empty
	...
	21,  // 115: daemon.StartedService.GetClashModeStatus:output_type -> daemon.ClashModeStatus
	20,  // 116: daemon.StartedService.SubscribeClashMode:output_type -> daemon.ClashMode
	110, // 117: daemon.StartedService.SetClashMode:output_type -> google.protobuf.Empty
	110, // 118: daemon.StartedService.URLTest:output_type -> google.protobuf.Empty
	17,  // 119: daemon.StartedService.URLTestItemsV2:output_type -> daemon.URLTestItemsV2Response
	110, // 120: daemon.StartedService.SelectOutbound:output_type -> google.protobuf.Empty
	110, // 121: daemon.StartedService.SetGroupExpand:output_type -> google.protobuf.Empty
	24,  // 122: daemon.StartedService.SubscribeConnections:output_type -> daemon.ConnectionEvents
	110, // 123: daemon.StartedService.CloseConnection:output_type -> google.protobuf.Empty
	110, // 124: daemon.StartedService.CloseAllConnections:output_type -> google.protobuf.Empty
	28,  // 125: daemon.StartedService.GetDeprecatedWarnings:output_type -> daemon.DeprecatedWarnings
	30,  // 126: daemon.StartedService.GetStartedAt:output_type -> daemon.StartedAt
	31,  // 127: daemon.StartedService.SubscribeOutbounds:output_type -> daemon.OutboundList
	33,  // 128: daemon.StartedService.StartNetworkQualityTest:output_type -> daemon.NetworkQualityTestProgress
	35,  // 129: daemon.StartedService.StartSTUNTest:output_type -> daemon.STUNTestProgress
	36,  // 130: daemon.StartedService.SubscribeTailscaleStatus:output_type -> daemon.TailscaleStatusUpdate
	41,  // 131: daemon.StartedService.StartTailscalePing:output_type -> daemon.TailscalePingResponse
	110, // 132: daemon.StartedService.SetTailscaleExitNode:output_type -> google.protobuf.Empty
	110, // 133: daemon.StartedService.TailscaleLogout:output_type -> google.protobuf.Empty
	48,  // 134: daemon.StartedService.StartTailscaleSSHSession:output_type -> daemon.TailscaleSSHServerMessage
	56,  // 135: daemon.StartedService.SubscribeTaildropInbox:output_type -> daemon.TaildropInbox
	110, // 136: daemon.StartedService.MarkTaildropInboxRead:output_type -> google.protobuf.Empty
	64,  // 137: daemon.StartedService.SendTaildropFiles:output_type -> daemon.TaildropSendServerMessage
	67,  // 138: daemon.StartedService.DownloadTaildropFile:output_type -> daemon.DownloadTaildropFileChunk
	110, // 139: daemon.StartedService.DeleteTaildropFile:output_type -> google.protobuf.Empty
	110, // 140: daemon.StartedService.CancelTaildropReceiving:output_type -> google.protobuf.Empty
	71,  // 141: daemon.StartedService.ProvideUSBDevices:output_type -> daemon.USBServerMessage
	82,  // 142: daemon.StartedService.SubscribeUSBIPServerStatus:output_type -> daemon.USBIPServerStatusUpdate
	85,  // 143: daemon.StartedService.SubscribeOpenConnectStatus:output_type -> daemon.OpenConnectStatusUpdate
	110, // 144: daemon.StartedService.SubmitOpenConnectAuthResponse:output_type -> google.protobuf.Empty
	110, // 145: daemon.StartedService.CancelOpenConnectAuthChallenge:output_type -> google.protobuf.Empty
	99,  // 146: daemon.StartedService.SubscribeOpenVPNStatus:output_type -> daemon.OpenVPNStatusUpdate
	110, // 147: daemon.StartedService.SubmitOpenVPNChallengeResponse:output_type -> google.protobuf.Empty
	110, // 148: daemon.StartedService.CancelOpenVPNChallenge:output_type -> google.protobuf.Empty
	105, // 149: daemon.StartedService.SubscribeNotifications:output_type -> daemon.NotificationEvent
...
func file_daemon_started_service_proto_init() {
	...
	file_daemon_started_service_proto_msgTypes[54].OneofWrappers = []any{
	...
	file_daemon_started_service_proto_msgTypes[83].OneofWrappers = []any{
	...
	file_daemon_started_service_proto_msgTypes[100].OneofWrappers = []any{
