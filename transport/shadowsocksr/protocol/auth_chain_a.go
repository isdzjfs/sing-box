...
import (
	...
	"github.com/sagernet/sing-box/transport/shadowsocksr/internal/log"
...
func (a *authChainA) Decode(dst, src *bytes.Buffer) error {
	...
	for src.Len() > 4 {
		...
		// Guard malformed length fields before slicing packet data.
		...
		// Guard malformed random padding offsets before slicing payload data.
